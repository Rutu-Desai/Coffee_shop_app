...
const TabNavigator = () => {
  return (
    <Tab.Navigator screenOptions={{tabBarHideOnKeyboard:true, headerShown:false, tabBarShowLabel:false, tabBarStyle: styles.tabBarStyle, 
        tabBarBackground: () => (
        ...
        <Tab.Screen name='Add' component={BlogScreen} 
            options={{tabBarIcon: ({focused,color,size}) => (
                <CustomIcon name="add" size={25} color={focused? COLORS.primaryOrangeHex : COLORS.primaryLightGreyHex} />
            )
        }}></Tab.Screen>
